...
mock.module('@/lib/api', () => ({ ApiError: class ApiError extends Error { code = 0 }, publicAgentsApi: { getPublicAgent: mock(async () => ({ id: 'agent-1', name: 'Agent', description: '', icon: '', avatar_url: '', opening_message: '', suggested_questions: [], variables: [], enable_vision: false, enable_file_upload: false, file_upload_config: null, hide_tool_calls: false, hide_message_actions: false, hide_reasoning: false, created_by: { username: 'owner' } })) } }))
...
const metadata = { id: 'agent-1', name: 'Agent', description: '', icon: '', avatar_url: '', opening_message: '', suggested_questions: ['What can you do?'], variables: [], enable_vision: false, enable_file_upload: false, file_upload_config: null, hide_tool_calls: false, hide_message_actions: false, hide_reasoning: false, created_by: { username: 'owner' } }
...
describe('AgentRunPage', () => {
  ...
  test('renders the chat workspace once metadata loads', async () => {
    ...
    effectIndex = 0
    states.length = 0
    states[0] = { id: 'agent-1', name: 'Agent', description: '', icon: '', avatar_url: '', opening_message: '', suggested_questions: [], variables: [{ name: 'query', type: 'string', required: true, hidden: false }], enable_vision: false, enable_file_upload: false, file_upload_config: null, hide_tool_calls: false, hide_message_actions: false, hide_reasoning: false, created_by: { username: 'owner' } }
    states[1] = false
    states[2] = null
    states[3] = ''
    states[4] = false
