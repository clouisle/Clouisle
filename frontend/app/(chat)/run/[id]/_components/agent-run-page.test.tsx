...
mock.module('@/components/chat', () => ({ ChatContainer: () => null, ChatInput: () => null, PendingAskUserForm: () => null, VariableForm: () => null, useVariableForm: () => ({ values: {}, setValues: mock(() => {}), needsInput: false, fieldErrors: {}, validate: () => true }) }))
