...
mock.module('./_components/notifications-admin-client', () => ({
  NotificationsAdminClient: function NotificationsAdminClient() {},
}))

const { default: NotificationsAdminPage } = await import('./page')

test('renders notification management inside the permission-protected dashboard layout', () => {
  const tree = NotificationsAdminPage() as { props: Record<string, unknown> }
