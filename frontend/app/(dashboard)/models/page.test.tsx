...
mock.module('./_components', () => ({ ModelsClient: function ModelsClient() {} }))

const { default: ModelsPage } = await import('./page')

test('renders model management inside the permission-protected dashboard layout', () => {
  const tree = ModelsPage() as { props: Record<string, unknown> }
