...
const kbSteps: OnboardingStep[] = [
  ...
  {
    target: '[data-testid^="kb-document-status-pending-"]',
  ...
  {
    target: '[data-testid^="kb-document-status-processing-"]',
    content: 'onboarding.step31i.description',
    title: 'onboarding.step31i.title',
    placement: 'auto',
    targetWaitTimeout: 0,
    route: '/app/kb',
  },
  {
    target: '[data-testid^="kb-document-status-completed-"]',
    content: 'onboarding.step31j.description',
    title: 'onboarding.step31j.title',
    placement: 'auto',
    targetWaitTimeout: 0,
    route: '/app/kb',
  },
  {
    target: '[data-testid^="kb-document-status-error-"]',
    content: 'onboarding.step31k.description',
    title: 'onboarding.step31k.title',
    placement: 'auto',
    targetWaitTimeout: 0,
    route: '/app/kb',
  },
