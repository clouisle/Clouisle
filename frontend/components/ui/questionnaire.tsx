...
function QuestionnaireProgress({
  ...
  return (
    <QuestionnairePrimitive.Progress
      ...
      className={cn(
        "min-h-[1lh] w-fit min-w-[10ch] text-xs font-medium text-muted-foreground tabular-nums",
        className
      )}
      {...props}
    />
...
function QuestionnaireTitle({
  ...
  return (
    <QuestionnairePrimitive.Title
      ...
      className={cn(
        "text-sm font-medium leading-snug text-foreground text-pretty",
        className
      )}
      {...props}
    />
...
function QuestionnaireChoice({
  ...
  return (
    <QuestionnairePrimitive.Choice
      ...
      className={cn(
        "group/questionnaire-choice relative flex w-full min-h-9 cursor-pointer items-center gap-2.5 rounded-md border border-input bg-background/50 px-3 py-1.5 text-start text-sm transition-colors outline-none select-none hover:bg-muted/50 has-[>input:focus-visible]:border-ring has-[>input:focus-visible]:ring-2 has-[>input:focus-visible]:ring-ring/50 data-invalid:border-destructive data-checked:border-primary/40 data-checked:bg-primary/5 data-checked:text-foreground dark:data-checked:bg-primary/10",
    ...
    >
      ...
      <QuestionnairePrimitive.ChoiceShortcut
        ...
        className="pointer-events-none ms-auto hidden size-5 shrink-0 items-center justify-center rounded border border-input bg-muted/60 font-mono text-[0.625rem] leading-none font-medium text-muted-foreground group-data-[shortcut]/questionnaire-choice:inline-flex"
      />
    </QuestionnairePrimitive.Choice>
  )
}
...
function QuestionnaireActions({
  ...
  return (
    <div
      ...
      className={cn(
        "flex w-full items-center justify-between gap-2 pt-1",
        className
      )}
      {...props}
    />
