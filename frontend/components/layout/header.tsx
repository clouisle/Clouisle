...
const SEARCHABLE_DASHBOARD_ROUTES: SearchRouteItem[] = [
  ...
  { titleKey: 'nav:capabilities', url: '/capabilities', icon: Wrench },
  { titleKey: 'tools:tabs.tools', url: '/capabilities', icon: Wrench, parentKey: 'nav:capabilities', keywords: ['tools'] },
  { titleKey: 'tools:tabs.skills', url: '/capabilities?tab=skills', icon: Wrench, parentKey: 'nav:capabilities', keywords: ['skills'] },
  { titleKey: 'tools:createMenu.http', url: '/capabilities', icon: Wrench, parentKey: 'nav:capabilities', keywords: ['http tool', 'api tool'] },
  { titleKey: 'tools:createMenu.code', url: '/capabilities/code', icon: Wrench, parentKey: 'nav:capabilities', keywords: ['code tool', 'python', 'runtime'] },
  { titleKey: 'tools:createMenu.mcp', url: '/capabilities', icon: Wrench, parentKey: 'nav:capabilities', keywords: ['mcp server'] },
