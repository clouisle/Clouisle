...
describe('admin conversation API requests', () => {
  ...
  it('uses exact stats, detail, and deletion routes', async () => {
    ...
    await conversationsApi.getStats('team-1', true)
    await conversationsApi.getTrends()
    await conversationsApi.getTrends('team-1', '30d', true)
    ...
    expect(get).toHaveBeenNthCalledWith(2, '/conversations/stats?team_id=team-1&own_only=true')
    expect(get).toHaveBeenNthCalledWith(3, '/conversations/stats/trends?period=7d')
    expect(get).toHaveBeenNthCalledWith(4, '/conversations/stats/trends?team_id=team-1&period=30d&own_only=true')
