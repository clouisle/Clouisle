...
import type { TriggerType, Workflow, WorkflowCreateInput, WorkflowListItem, WorkflowStatus, WorkflowUpdateInput, WorkflowVisibility } from '../workflows'
...
export const adminWorkflowsApi = {
  ...
  create: async (data: WorkflowCreateInput): Promise<AdminWorkflowDetail> =>
    api.post<AdminWorkflowDetail>('/admin/workflows', data),
