...
import type { Agent, AgentCreateInput, AgentListItem, AgentStatus, AgentUpdateInput, AgentVisibility } from '../agents'
...
export const adminAgentsApi = {
  ...
  create: async (data: AgentCreateInput): Promise<AdminAgentDetail> =>
    api.post<AdminAgentDetail>('/admin/agents', data),
