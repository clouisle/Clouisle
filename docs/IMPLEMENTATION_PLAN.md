...
- **issue-255-test-coverage** — In progress. Establish honest backend and frontend coverage measurement, cover critical happy/error paths, and enforce independent 95% CI gates. See `docs/plan/issue-255-test-coverage.md`
  ...
  - [ ] 3. Backend critical-path coverage — 3,313 tests; 82.04% lines, 67.00% branches; complete backend remains below 95%
  - [ ] 4. Frontend critical-path coverage — 1,809 isolated tests; 96.75% lines, 92.73% functions; 470/470 source census passing
