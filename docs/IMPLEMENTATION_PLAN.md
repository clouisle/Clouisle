...
- **issue-255-test-coverage** — In progress. Establish honest backend and frontend coverage measurement, cover critical happy/error paths, and enforce independent 95% CI gates. See `docs/plan/issue-255-test-coverage.md`
  ...
  - [ ] 3. Backend critical-path coverage — 3,778 tests; 85.86% lines, 73.02% branches; complete backend remains below 95%
  - [ ] 4. Frontend critical-path coverage — 1,902 isolated tests; 97.36% lines, 93.69% functions; 470/470 source census passing
