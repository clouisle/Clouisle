...
- **issue-255-test-coverage** — In progress. Establish honest backend and frontend coverage measurement, cover critical happy/error paths, and enforce independent 95% CI gates. See `docs/plan/issue-255-test-coverage.md`
  ...
  - [ ] 3. Backend critical-path coverage — 3,254 tests; 81.76% lines, 86.53% branches; complete backend remains below 95%
  - [ ] 4. Frontend critical-path coverage — 1,798 isolated tests; 96.73% lines, 92.62% functions; source census passing
