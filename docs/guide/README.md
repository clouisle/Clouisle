...
Welcome to the user and operator documentation for Clouisle. For the extended Chinese product overview and translated navigation, see [README_zh-CN.md](README_zh-CN.md).
...
### User guide
- [Authentication: login and registration](user-guide/authentication/login-register.md)
- [Password management](user-guide/authentication/password-management.md)
- [Single sign-on](user-guide/authentication/sso-user-guide.md)
- [Profile settings](user-guide/profile/profile-settings.md)
- [Notifications](user-guide/profile/notifications.md)
- [Teams](user-guide/teams/joining-teams.md)
- [Team collaboration](user-guide/teams/team-collaboration.md)
- [Team roles](user-guide/teams/team-roles.md)
- [Knowledge bases](user-guide/knowledge-base/browsing-kb.md)
...
- [Workflow builder](user-guide/workflows/workflow-builder.md)
- [Workflow nodes](user-guide/workflows/workflow-nodes.md)
- [Run workflows](user-guide/workflows/running-workflows.md)
...
- [Team management](admin-guide/teams/team-management.md)
- [Knowledge base management](admin-guide/knowledge-base/kb-management.md)
- [Agent management](admin-guide/agents/agent-management.md)
...
### Best practices
- [Prompt engineering](best-practices/prompt-engineering.md)
- [Knowledge base optimization](best-practices/kb-optimization.md)
...
- Internal developer docs: `../dev/README.md`
