...
Welcome to the user and operator documentation for Clouisle.
...
- [Profile](user-guide/profile/)
- [Teams](user-guide/teams/)
- [Knowledge Base](user-guide/knowledge-base/)
- [Chat](user-guide/chat/)
- [Workflows](user-guide/workflows/)
- [API Keys](user-guide/api-keys/)

### Admin guide
- [Users](admin-guide/users/)
- [Teams](admin-guide/teams/)
- [Knowledge Bases](admin-guide/knowledge-base/)
- [Agents](admin-guide/agents/)
- [Workflows](admin-guide/workflows/)
- [Models](admin-guide/models/)
- [Tools](admin-guide/tools/)
- [Permissions](admin-guide/permissions/)
- [Settings](admin-guide/settings/)
- [Audit Logs](admin-guide/audit-logs/)
...
- [KB Optimization](best-practices/kb-optimization.md)
