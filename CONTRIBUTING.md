...
This project and everyone participating in it is governed by the [Clouisle Code of Conduct](CODE_OF_CONDUCT.md). By participating, you are expected to uphold this code.
...
This section guides you through submitting an enhancement suggestion for Clouisle, **including completely new features and minor improvements to existing functionality**. Following these guidelines will help maintainers and the community to understand your suggestion and find related suggestions.
