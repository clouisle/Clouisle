...
admin_router.include_router(agents.router, prefix="/agents", tags=["admin-agents"])
...
admin_router.include_router(workflows.router, prefix="/workflows", tags=["admin-workflows"])
