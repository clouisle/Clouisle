...
class KnowledgeBase(models.Model):
    ...
    # Expose team_id for type checking (auto-generated by Tortoise ORM)
    ...
    embedding_model_id: UUID | None = fields.UUIDField(  # type: ignore[assignment]
        null=True, description="ID of the embedding model to use"
    )
    rerank_model_id: UUID | None = fields.UUIDField(  # type: ignore[assignment]
...
class DocumentChunk(models.Model):
    ...
    error_message: str | None = fields.TextField(  # type: ignore[assignment]
        null=True, description="Embedding error message"
    )
