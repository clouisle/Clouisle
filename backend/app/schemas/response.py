...
class ResponseCode(IntEnum):
    ...
    CANNOT_DELETE_SYSTEM_PERMISSION = 5202
    CANNOT_UPDATE_SYSTEM_PERMISSION = 5203
    CANNOT_MODIFY_SYSTEM_ROLE = 5204
    CANNOT_DELETE_DEFAULT_TEAM = 5205
    CANNOT_ADD_AS_OWNER = 5206
    CANNOT_CHANGE_OWNER_ROLE = 5207
    CANNOT_PROMOTE_TO_OWNER = 5208
    CANNOT_REMOVE_OWNER = 5209
    OWNER_CANNOT_LEAVE = 5210
    ROLE_IN_USE = 5211
    USER_ALREADY_ACTIVE = 5212
    USER_ALREADY_INACTIVE = 5213
    CANNOT_DEACTIVATE_SUPERUSER = 5214
    ...
    PASSWORD_EXPIRED = 5304
    FORCE_PASSWORD_CHANGE_REQUIRED = 5305
    PASSWORD_MIN_AGE_NOT_MET = 5306
    PASSWORD_RECENTLY_USED = 5307
    # TOTP 2FA errors (5310-5319)
    TOTP_REQUIRED = 5310
    TOTP_INVALID = 5311
    TOTP_RATE_LIMITED = 5312
    TOTP_NOT_ENABLED = 5313
    TOTP_ALREADY_ENABLED = 5314
    TOTP_SETUP_EXPIRED = 5315
    TOTP_SETUP_REQUIRED = 5316
    ...
    MODEL_VISION_NOT_SUPPORTED = 6105
    MODEL_DISABLED = 6106

    # Agent 相关错误 (6200-6299)
    AGENT_NOT_FOUND = 6200
    AGENT_ACCESS_DENIED = 6201
    AGENT_NOT_PUBLISHED = 6202
    CONVERSATION_NOT_FOUND = 6210
    MESSAGE_NOT_FOUND = 6211

    # SSO 相关错误 (6300-6399)
    SSO_PROVIDER_NOT_FOUND = 6300
    SSO_SESSION_EXPIRED = 6301
    SSO_REGISTRATION_DISABLED = 6302
    SSO_AUTHENTICATION_FAILED = 6303
    SSO_INVALID_CONFIGURATION = 6304
    SSO_PROVIDER_NAME_EXISTS = 6305
    PASSWORD_LOGIN_DISABLED = 6306
