...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("memory_async_extraction_enabled", False, True),
        ("memory_async_extraction_enabled", "false", False),
        ("memory_extraction_model_id", "", True),
        ("memory_extraction_model_id", "model-1", True),
        ("memory_extraction_model_id", None, False),
        ("memory_extraction_cooldown_seconds", 10, True),
        ("memory_extraction_cooldown_seconds", 3600, True),
        ("memory_extraction_cooldown_seconds", 9, False),
        ("memory_extraction_cooldown_seconds", 3601, False),
        ("memory_extraction_cooldown_seconds", True, False),
        ("memory_extraction_max_pending_turns", 1, True),
        ("memory_extraction_max_pending_turns", 50, True),
        ("memory_extraction_max_pending_turns", 0, False),
        ("memory_extraction_max_pending_turns", 51, False),
        ("memory_extraction_max_pending_turns", False, False),
    ],
)
